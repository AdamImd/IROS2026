...
\title{\LARGE \bf Scalable Low-Cost Force-Sensing Skin for Mobile Manipulators
% (LoFiSkin)
}
...
\renewcommand\twocolumn[1][]{%
    \oldtwocolumn[{#1}{
        ...
        \captionof{figure}{\ktxt{TODO}. \acro{} enables whole-arm tactile sensing by utilizing 3D printed TPU shells with embedded force-sensitive resistor arrays. Contact-aware inverse kinematics allows the robot to both embrace and avoid contact during manipulation.}\label{fig:intro}}]
}
