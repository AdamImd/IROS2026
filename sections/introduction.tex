...
To bridge these gaps, we introduce \acro{}, a low-cost and robust tactile skin that can be readily integrated into diverse robot embodiments. \acro{} builds on \cite{FSR_WTL} and uses 3D-printed inner and outer shells that form a high-coverage array of force-sensitive resistors (FSRs), generated directly from the arm's 3D mesh to conform to complex geometries.
