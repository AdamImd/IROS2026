...
\begin{itemize}
    \item A low-cost, whole-arm tactile skin (\acro{}) consisting of modules with high-coverage sensor arrays built with fabric or TPU layers, designed for easy fabrication and integration with existing robot platforms.
