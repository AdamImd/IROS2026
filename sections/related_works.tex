...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{images/CLOAK_Overall_Both.pdf}
\caption{Illustration of the tactile sensor design. Left: TPU Sensor 1) showing the sensor on the Spot Robot arm, 2) showing the inner and outer layers of the sensor along with their ridges, 3) showing the 3D structure of the taxel array, 4) showing the 2D cross-section before and during contact, 5) showing the layer structure of each taxel. Right: Fabric Sensor 1) showing the sensor on the Spot Robot arm, 2) showing the sensor on the joint, 3) showing the layers of the sensor. \ktxt{TODO Right (1)}} 
