...
\subsection{Full Skin Power Law}
We observe that once sufficent contact is made betweeen the inner and outer layers, the response of the sensor follows a power law relationship between force and resistance. We fit a power law curve to the loading responses of each taxel, and find that the exponent of the power law is generally \ktxt{TODO}. 
