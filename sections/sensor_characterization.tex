...
Overall, the textile sensor performs better for low-force interactions, with a near-zero detection threshold in the flat configuration and strong response at light contacts. In contrast, the AM sensor has an elevated detection threshold due to the designed gap between inner and outer shells; as force increases, shell deformation closes this gap and produces a sharper resistance transition.

When wrapped on the robot arm and tightened with hook-and-loop fastening, the effective sensitive range of Velostat-based sensors decreases relative to flat characterization (Fig.~\ref{fig:overall_comparison}). In our tests, mounting primarily reduced the textile sensor's maximum force range, likely due to pre-compression and non-uniform pressure distribution across curved surfaces. Velostat bending sensitivity may also shift baseline resistance and response behavior \ktxt{TODO:CITE WTL WORK ON CURVED VELOSTAT}.
...
Across tested configurations, textile and AM sensors show similar repeatability scores (Fig.~\ref{fig:overall_comparison}, top), indicating stable repeated measurements under matched calibration conditions. However, the AM sensor exhibits higher hysteresis (Fig.~\ref{fig:overall_comparison}, bottom), which we attribute primarily to viscoelastic effects in the AM shell. The textile sensor shows more consistent loading and unloading curves, suggesting lower hysteresis under these test conditions.
