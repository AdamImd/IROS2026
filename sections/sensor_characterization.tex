...
\subsubsection{Findings}
Across tested configurations, textile and AM sensors show similar repeatability scores (Fig.~\ref{fig:overall_comparison}, middle), indicating comparable cycle-to-cycle variation under matched calibration conditions. However, the AM sensor exhibits higher hysteresis than the textile sensor (Fig.~\ref{fig:overall_comparison}, right), which we attribute primarily to viscoelastic effects in the AM shell. The textile sensor shows a smaller separation between loading and unloading curves under these test conditions.
