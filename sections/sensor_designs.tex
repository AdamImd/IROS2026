...
\end{enumerate}
 ...
 The fabrication of this sensor requires a 3D printer capable of printing flexible filaments, copper tape, Velostat, and wiring, and the material cost remains under \textit{\$10} per Spot arm link, excluding shared readout electronics.
...
For the AM sensor, the dominant variables are shell thickness, ridge height, ridge spacing, and print infill density. To shift the sensing range downward, one can decrease the shell thickness, utilize softer TPU-like materials, decrease infill density, or lower the ridge height. To shift the range upward, these parameters are reversed: increasing ridge height, material stiffness, and infill density increases resistance to deformation. Expanding the force range is achieved by increasing outer material thickness or adding a spacer, while narrowing it involves thinner/softer materials combined with higher infill density. Hysteresis in the AM sensor is a byproduct of the material's viscoelasticity and depends on the infill density and outer shell stiffness. The AM sensor's design reduces installation variability through its rigid-conformal shell, though it remains susceptible to performance variance stemming from infill geometry and 3D-printing artifacts.
