\begin{figure*}[!t]
    \centering
    \includegraphics[width=1.0\linewidth,trim=0 6pt 0 0,clip]{images/Results_V7.pdf}
    \vspace{-18pt}
    \caption{Real-world deployment of the textile and AM sensors across representative manipulation scenarios. For each scenario, the lower panel visualizes tactile responses during contact, and the annotated values report the corresponding force ranges estimated from the sensor models.}\label{fig:results}
\end{figure*}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\columnwidth,trim=0 27pt 0 0,clip]{images/Circuit_v2.pdf}
    \vspace{-3pt}
